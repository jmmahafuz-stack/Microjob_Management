...
urlpatterns = [
    ...
    path('<int:pk>/cancel/', views.cancel_booking, name='cancel_booking'),
        path('<int:pk>/worker-cancel/', views.worker_cancel_booking, name='worker_cancel_booking'),
    ...
    path('jobs/<int:pk>/take/', views.worker_take_service, name='worker_take_service'),
    path('jobs/<int:pk>/worker-cancel/', views.worker_cancel_job, name='worker_cancel_job'),
    ...
    path('jobs/<int:pk>/customer-price/', views.customer_update_price, name='customer_update_price'),
